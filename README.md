...
| log.file                        | Enables logging on file (location: /var/log/influxdb-storer-logs-%DATE%.log)                                 | false                       | boolean                  | CRON_LOG_FILE                        |
...
| dbOptions.connectTimeoutMS   | How long the MongoDB driver will wait before killing a socket due to inactivity during initial connection | integer       | 2500                    | CRON_DBOPTION_.CONNECTTIMEOUTMS   |
...
__NOTE THAT__  you can use the official image provided by dojot in its  [DockerHub page](https://hub.docker.com/r/dojot/cron.
